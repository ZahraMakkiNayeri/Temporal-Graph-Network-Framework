...
def main():
    ...
    # Match the training runs' split protocol exactly: run_train.py passes
    # different_new_nodes_between_val_and_test=True, which changes the new-node
    # split. Without this, EdgeBank's inductive numbers are computed on a
    # different evaluation set from every other method.
